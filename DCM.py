...
class TR_IMUFilter:
    ...
    def getQuaternion(self):
        ...
        self.updateAHRS(self.gyroX * math.pi / 180, self.gyroY * math.pi / 180, self.gyroZ * math.pi / 180, self.accelX, self.accelY, self.accelZ)
    ...
    def updateAHRS(self, gx, gy, gz, ax, ay, az):
        recipNorm = 0.0
        halfex = 0.0
        halfey = 0.0
        halfez = 0.0
